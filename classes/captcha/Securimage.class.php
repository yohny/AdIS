...
/**
  ...
  2.0.2
  - Added support for better pathing to include securimage into existing applications (Nathan Phillip Brink)
...
class Securimage
{
    ...
    var $charset;
    /**
     * File with list of words used to create codes
     *
    ...
    // Line options
    /**
     * Number of confuse-curves in the image.
     *
    ...
    var $image_signature;
    /**
     * Color to use for signature text
     *
     * @since 2.0
     * @var Securimage_Color
     */
    ...
    function setBackground()
    {
        ...
        if ($this->bgimg == null)//two choises - no background OR random background
        {
        ...
        //else $img not null - we use users background
    ...
    function drawWord()
    {
        ...
        if ($this->use_gd_font == true || !is_readable($this->ttf_file) || !function_exists('imagettftext'))
        {
...
//function
    ...
    function validate()
    {
        ...
        } // else the code was not found anywhere, validation should fail
